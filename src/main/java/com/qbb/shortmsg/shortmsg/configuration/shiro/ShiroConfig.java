...
import com.qbb.shortmsg.shortmsg.configuration.RedisCacheManager;
import com.qbb.shortmsg.shortmsg.configuration.shiro.CustomRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/loginGo", "anon");
    ...
    /**
     * *
     * 开启Shiro的注解(如@RequiresRoles,@RequiresPermissions(准许许可)),需借助SpringAOP扫描使用Shiro注解的类,并在必要时进行安全逻辑验证
     * *
